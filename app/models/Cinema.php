<?php
    class Cinema {
        ...
        public function addEmployees($data){
            ...
            (`employee_id`, `first_name`, `last_name`,`email`, `phone`, `birthdate`, `salary`, `hire_date`, `ssn`, `address_id`, `store_number`, `manager_id`) 
                 VALUES(NULL,:first_name,:last_name,:email, :phone, :birthdate, :salary, :hire_date, :ssn, NULL, :store_number, :manager_id )');
            //bind the values
