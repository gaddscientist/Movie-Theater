<?php require APPROOT . '/views/inc/header.php'; ?>
    <div class="col-md-8 mx-auto">
        <div class="card card-body bg-light my-5 pb-0">
            ...
            <form class="mt-2" action="<?php echo URLROOT; ?>/cinemas/modify/<?php echo $data['cinema_id']; ?>/<?php echo $data['manager_id']; ?>" method="post">
                <!-- First Row -->
                <div class="d-flex">
                    <div class="form-group w-50 pr-2">
                        <label for="first_name">First Name <sup>*</sup></label> 
                        <input type="text" name="first_name" 
                            class="form-control form-control-sm <?php echo (!empty($data['first_name_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group w-50 pl-2">
                        ...
                        <input type="text" name="last_name" 
                            class="form-control form-control-sm <?php echo (!empty($data['last_name_err'])) ? 'is-invalid' : '';?>" 
                ...
                <div class="d-flex">
                    ...
                    <div class="form-group w-50 pl-2">
                        ...
                        <input type="text" name="phone" 
                            class="form-control form-control-sm <?php echo (!empty($data['phone_err'])) ? 'is-invalid' : '';?>" 
                ...
                <div class="d-flex justify-content-between">
                    <div class="form-group group-3">
                        ...
                        <input type="date" name="birthdate" 
                            class="form-control form-control-sm <?php echo (!empty($data['birthdate_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group group-3">
                        ...
                        <input type="number" name="salary" min="0" step=".01" 
                            class="form-control form-control-sm <?php echo (!empty($data['salary_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group group-3">
                        ...
                        <input type="ssn" name="ssn" 
                            class="form-control form-control-sm <?php echo (!empty($data['ssn_err'])) ? 'is-invalid' : '';?>" 
                ...
                <div class="d-flex justify-content-between">
                    <div class="form-group pr-2 w-25">
                        ...
                        <input type="text" name="street_address" 
                            class="form-control form-control-sm <?php echo (!empty($data['street_address_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group px-2 w-25">
                        ...
                        <input type="text" name="city"
                            class="form-control form-control-sm <?php echo (!empty($data['city_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group px-2 w-25">
                        ...
                        <input type="text" name="state" 
                            class="form-control form-control-sm <?php echo (!empty($data['state_err'])) ? 'is-invalid' : '';?>" 
                    ...
                    <div class="form-group pl-2 w-25">
                        ...
                        <input type="text" name="zip" 
                            class="form-control form-control-sm <?php echo (!empty($data['zip_err'])) ? 'is-invalid' : '';?>" 
                ...
                <div class="card-footer row d-flex justify-content-center">
                    <div>
                        <input type="submit" value="Add Employee" class="btn btn-success btn-block pb-2"> 
                    </div> 
                </div>
            </form>
        </div>
